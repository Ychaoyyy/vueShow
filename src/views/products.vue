        ...
        <div class="sidebar__wrapper">
          <div class="sidebar__inner">
            <a class="sidebar__logo" href="index.html"
              ><img
                class="sidebar__pic"
                src="/src/assets/img/logo-sm.png"
                alt=""
            /></a>
            <div class="sidebar__list">
              <div class="sidebar__group">
                ...
                <div class="sidebar__menu">
                  ...
                  ><a class="sidebar__item active" href="/products">
                    <div class="sidebar__icon">
                  ...
                  ><a class="sidebar__item" href="/schedules">
                    <div class="sidebar__icon">
        ...
        <div class="page__center">
          <div class="page__row page__row_head">
            <div class="page__col">
              ...
              <div class="page__welcome h2">
                Welcome back<span class="desktop-hide">👋</span>
              </div>
            </div>
            <div class="page__col">
              <div class="header">
                ...
                <div class="notifications">
                  ...
                  <div class="notifications__wrap">
                    <div class="notifications__info h6">
                      Recent Notification
                    </div>
                      ...
                      <div class="dropdown js-dropdown">
                        <div class="dropdown__body js-dropdown-body">
                          <a class="dropdown__item" href="#">
                            ...
                            <div class="dropdown__info caption">
                              Illustration
                            </div> </a
                          ><a class="dropdown__item" href="#">
                            <div class="dropdown__title title">
                      ...
                      <div class="sorting__actions">
                        ...
                        ><button class="sorting__action">
                          <svg class="icon icon-box">
                            <use
                              xlink:href="/src/assets/img/sprite.svg#icon-box"
                            ></use>
                          </svg>
                        </button>
                      </div>
                    ...
                    <div class="products__cell">
                      <label class="checkbox"
                        ><input class="checkbox__input" type="checkbox" /><span
                          class="checkbox__in"
                          ><span class="checkbox__tick"></span></span
                      ></label>
                    </div>
                  ...
                  <div class="products__row">
                    ...
                    <div class="products__cell">
                      <a class="products__item" href="#">
                        <div class="products__preview">
                          <img
                            class="products__pic"
                            src="/src/assets/img/product-pic.png"
                            alt=""
                          />
                        </div>
                        <div class="products__details">
                          ...
                          <div class="products__info caption color-gray">
                            3D Illustration
                          </div>
                        </div>
                      </a>
                      ...
                      <div class="products__cost">
                        ...
                        <div class="products__tooltip">
                          <div class="products__sale">
                            <div class="products__icon bg-red">
                              <img
                                class="products__pic"
                                src="/src/assets/img/chat-black.svg"
                                alt=""
                              />
                            </div>
                            <div class="products__caption caption-sm">
                              Latest Sale
                            </div>
                          </div>
                    ...
                    <div class="products__cell">
                      <div class="products__rating">
                        <span class="color-green">5.0</span> (45 votes)
                      </div>
                    </div>
                  </div>
